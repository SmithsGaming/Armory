...
public class GuiFirePit extends GuiContainerSmithsCore {
    ...
    public void registerComponents (IGUIBasedComponentHost host) {
        registerNewComponent(new ComponentBorder("test", host, new Coordinate2D(0, 0), 300, 750, new MinecraftColor(MinecraftColor.WHITE), ComponentBorder.CornerTypes.Inwarts, ComponentBorder.CornerTypes.Inwarts, ComponentBorder.CornerTypes.Inwarts, ComponentBorder.CornerTypes.Inwarts));
    }
}
