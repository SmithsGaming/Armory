...
public class ModelBookBinder {
    public IModelCustom iModelCustom;

    public ModelBookBinder() {
        this.iModelCustom = AdvancedModelLoader.loadModel(new ResourceLocation(References.General.MOD_ID.toLowerCase() + ":" + References.Models.ModelLocations.BookBinder));
    }
