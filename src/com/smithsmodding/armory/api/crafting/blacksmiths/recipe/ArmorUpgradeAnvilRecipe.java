...
public class ArmorUpgradeAnvilRecipe extends AnvilRecipe {
    ...
    private ArrayList<Integer> iUpgradeComponents = new ArrayList<Integer>(TileEntityBlackSmithsAnvil.MAX_CRAFTINGSLOTS);
    ...
    public IAnvilRecipeComponent getComponent(int pComponentIndex) {
        if (pComponentIndex == 12) {
            return new StandardAnvilRecipeComponent(new ItemStack(GeneralRegistry.Items.metalRing)) {
                @Override
