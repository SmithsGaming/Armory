                    ...
                    if (pItemStack1.getItem() == pItemStack2.getItem())
                    {
                        ...
                        if (pItemStack1.getItemDamage() == pItemStack2.getItemDamage())
                        {
                            ...
                            if (pItemStack1.hasTagCompound() && pItemStack2.hasTagCompound())
                            {
                                ...
                                if (ItemStack.areItemStackTagsEqual(pItemStack1, pItemStack2)) { return (pItemStack1.stackSize - pItemStack2.stackSize); }
                                else { return (pItemStack1.getTagCompound().hashCode() - pItemStack2.getTagCompound().hashCode()); }
                            }
                            else if (!(pItemStack1.hasTagCompound()) && pItemStack2.hasTagCompound()) { return -1; }
                            else if (pItemStack1.hasTagCompound() && !(pItemStack2.hasTagCompound())) { return 1; }
                            else { return (pItemStack1.stackSize - pItemStack2.stackSize); }
                        }
                        else { return (pItemStack1.getItemDamage() - pItemStack2.getItemDamage()); }
                    }
                    else { return pItemStack1.getItem().getUnlocalizedName(pItemStack1).compareToIgnoreCase(pItemStack2.getItem().getUnlocalizedName(pItemStack2)); }
                }
                else { return Item.getIdFromItem(pItemStack1.getItem()) - Item.getIdFromItem(pItemStack2.getItem()); }
            }
            else if (pItemStack1 != null) { return -1; }
            else if (pItemStack2 != null) { return 1; }
            else { return 0; }
        }
    };
