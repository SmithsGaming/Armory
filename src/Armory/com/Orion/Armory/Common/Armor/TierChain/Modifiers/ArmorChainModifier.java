package com.Orion.Armory.Common.Armor.TierChain.Modifiers;
 ...
 */
public abstract class ArmorChainModifier extends MLAAddon
{
    ...
    //Constructors    
    public ArmorChainModifier(String pInternalName, String pParentID, String pArmorPositionID, String pVisibleName, String pVisibleNameColor, ArrayList<String> pRequiredModifiers, ArrayList<String> pModifierBlacklist, int pMaxModifications)
    {
    ...
    public abstract void applyEffectToArmorPiece(ArmorChain pArmorPiece, int pModifierLevel);
