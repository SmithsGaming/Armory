...
public abstract class ArmoryContainerGUI extends GuiScreen{
    //The renderer used to render items in itemstacks
    protected static RenderItem iItemRenderer = new RenderItem();

    /** The X/Y size of the inventory window in stretched pixels. */
    protected int iXSize = 176;
    protected int iYSize = 166;
    ...
    public ArmoryContainerGUI(Container pContainer)
    {
    ...
    public void initGui ()
    {
        ...
        this.guiLeft = (this.width - this.iXSize) / 2;
        this.guiTop = (this.height - this.iYSize) / 2;
    }
    ...
    protected void drawItemStack (ItemStack par1ItemStack, int par2, int par3, String par4Str)
    {
        ...
        this.zLevel = 200.0F;
        iItemRenderer.zLevel = 200.0F;
        iItemRenderer.renderItemAndEffectIntoGUI(this.fontRendererObj, this.mc.renderEngine, par1ItemStack, par2, par3);
        iItemRenderer.renderItemOverlayIntoGUI(this.fontRendererObj, this.mc.renderEngine, par1ItemStack, par2, par3 - (this.draggedStack == null ? 0 : 8), par4Str);
        this.zLevel = 0.0F;
        iItemRenderer.zLevel = 0.0F;
    }
    ...
    protected void drawSlotInventory (Slot par1Slot)
    {
        ...
        if (!flag1)
        {
            ...
            GL11.glEnable(GL11.GL_DEPTH_TEST);
            iItemRenderer.renderItemAndEffectIntoGUI(this.fontRendererObj, this.mc.renderEngine, itemstack, i, j);
            iItemRenderer.renderItemOverlayIntoGUI(this.fontRendererObj, this.mc.renderEngine, itemstack, i, j, s);
        }
    ...
    protected void mouseClicked (int mouseX, int mouseY, int mouseButton)
    {
        ...
        if (mouseButton == 0 || mouseButton == 1 || flag)
        {
            int gLeft = this.guiLeft;
            int gTop = this.guiTop;
            boolean flag1 = mouseX < gLeft || mouseY < gTop || mouseX >= gLeft + this.iXSize || mouseY >= gTop + this.iYSize;
            int k1 = -1;
    ...
    protected void mouseMovedOrUp (int par1, int par2, int par3)
    {
        ...
        int l = this.guiLeft;
        int i1 = this.guiTop;
        boolean flag = par1 < l || par2 < i1 || par1 >= l + this.iXSize || par2 >= i1 + this.iYSize;
        int j1 = -1;
