...
import old.Client.CreativeTab.ArmorTab;
import old.Client.CreativeTab.ComponentsTab;
...
public class ARegistry
{
    ...
    public ArmorUpgrade getUpgrade(InventoryCrafting pCraftingInventory)
    {
        for(ArmorUpgrade tUpgrade: iArmorUpgrades)
        {
            if (tUpgrade.iCrafingInventory == pCraftingInventory)
            {
                return tUpgrade;
            }
        }
