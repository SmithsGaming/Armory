...
public interface IHeatableObjectCapability extends IMaterializedStackCapability {
     ...
     */
    IHeatableObjectCapability setType(@Nonnull IHeatableObjectType type);
    ...
    class Impl extends IMaterializedStackCapability.Impl implements IHeatableObjectCapability {
        ...
        @Nonnull
        @Override
        public IHeatableObjectType getType() {
            return type;
        }
         ...
         */
        @Override
        public IHeatableObjectCapability setType(@Nonnull IHeatableObjectType type) {
            this.type = type;
            return this;
        }
