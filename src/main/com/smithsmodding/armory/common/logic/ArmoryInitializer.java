...
import com.smithsmodding.armory.common.anvil.StandardAnvilMaterial;
...
public class ArmoryInitializer {
    ...
    public static class MedievalInitialization {
        ...
        public static void registerMaterials() {
            ...
            HeatableItemRegistry.getInstance().addBaseStack(tObsidian, new ItemStack(Blocks.OBSIDIAN), References.InternalNames.HeatedObjectTypeNames.BLOCK, 9 * References.General.FLUID_INGOT);
            HeatableItemRegistry.getInstance().addBaseStack(tIron, new ItemStack(Blocks.IRON_BLOCK), References.InternalNames.HeatedObjectTypeNames.BLOCK, 9 * References.General.FLUID_INGOT);
        }
        ...
        public static void initializeAnvilRecipes() {
            ...
            AnvilRecipe forgeRecipe = new AnvilRecipe()
                    .setCraftingSlotContent(0, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(4, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(5, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.75F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.75F * 0.95F))
                    .setCraftingSlotContent(6, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.PLATE, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(7, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.PLATE, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(8, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.PLATE, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(9, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.75F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.75F * 0.95F))
                    .setCraftingSlotContent(10, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(14, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(15, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(19, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(20, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(21, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(22, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(23, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
                    .setCraftingSlotContent(24, new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.65F * 0.95F))
            ...
            AnvilRecipe tHammerRecipe = new AnvilRecipe().setCraftingSlotContent(3, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
                    .setCraftingSlotContent(7, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
                    .setCraftingSlotContent(9, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
                    .setCraftingSlotContent(13, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
                    .setCraftingSlotContent(14, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
            ...
            AnvilRecipe tTongRecipe = new AnvilRecipe().setCraftingSlotContent(3, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
                    .setCraftingSlotContent(7, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
                    .setCraftingSlotContent(9, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
                    .setCraftingSlotContent(13, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
                    .setCraftingSlotContent(12, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
                    .setCraftingSlotContent(11, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
                    .setCraftingSlotContent(15, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
                    .setCraftingSlotContent(17, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
                    .setCraftingSlotContent(21, (new HeatedAnvilRecipeComponent(References.InternalNames.Materials.Vanilla.IRON, References.InternalNames.HeatedObjectTypeNames.INGOT, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F)))
        ...
        public static void initializeMedievalArmorAnvilRecipes() {
            for (IArmorMaterial tMaterial : MaterialRegistry.getInstance().getArmorMaterials().values()) {
                ...
                pRingCompound.setString(References.NBTTagCompoundData.CoreMaterial, tMaterial.getUniqueID());
                tRingStack.setTagCompound(pRingCompound);

                AnvilRecipe tRingRecipe = new AnvilRecipe().setCraftingSlotContent(0, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.65F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.75F)))
                ...
                pNuggetCompound.setString(References.NBTTagCompoundData.CoreMaterial, tMaterial.getUniqueID());
                ...
                tChainCompound.setString(References.NBTTagCompoundData.CoreMaterial, tMaterial.getUniqueID());
                tChainStack.setTagCompound(tChainCompound);

                AnvilRecipe tChainRecipe = new AnvilRecipe().setCraftingSlotContent(2, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.65F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.75F)))
                        .setCraftingSlotContent(6, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.65F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.75F)))
                        .setCraftingSlotContent(8, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.65F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.75F)))
                        .setCraftingSlotContent(10, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.65F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.75F)))
                        .setCraftingSlotContent(12, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.65F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.75F)))
                        .setCraftingSlotContent(14, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.65F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.75F)))
                        .setCraftingSlotContent(16, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.65F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.75F)))
                        .setCraftingSlotContent(18, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.65F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.75F)))
                        .setCraftingSlotContent(22, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.65F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.75F)))
                ...
                ItemStack tChestplateStack = ArmorFactory.getInstance().buildNewMLAArmor(ArmorRegistry.getInstance().getArmor(References.InternalNames.Armor.MEDIEVALCHESTPLATE), new HashMap<MLAAddon, Integer>(), tMaterial.getBaseDurability(References.InternalNames.Armor.MEDIEVALCHESTPLATE), tMaterial.getUniqueID());
                AnvilRecipe tChestplateRecipe = new AnvilRecipe().setCraftingSlotContent(0, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(4, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(5, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(6, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(8, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(9, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(10, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(11, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(12, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(13, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(14, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(15, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(16, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(17, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(18, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(19, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(20, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(21, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(22, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(23, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(24, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                ...
                ItemStack tHelmetStack = ArmorFactory.getInstance().buildNewMLAArmor(ArmorRegistry.getInstance().getArmor(References.InternalNames.Armor.MEDIEVALHELMET), new HashMap<MLAAddon, Integer>(), tMaterial.getBaseDurability(References.InternalNames.Armor.MEDIEVALHELMET), tMaterial.getUniqueID());
                AnvilRecipe tHelmetRecipe = new AnvilRecipe().setCraftingSlotContent(0, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(1, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(2, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(3, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(4, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(5, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(6, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(7, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(8, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(9, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(10, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(12, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(14, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                ...
                ItemStack tPantsStack = ArmorFactory.getInstance().buildNewMLAArmor(ArmorRegistry.getInstance().getArmor(References.InternalNames.Armor.MEDIEVALLEGGINGS), new HashMap<MLAAddon, Integer>(), tMaterial.getBaseDurability(References.InternalNames.Armor.MEDIEVALLEGGINGS), tMaterial.getUniqueID());
                ...
                ItemStack tShoeStack = ArmorFactory.getInstance().buildNewMLAArmor(ArmorRegistry.getInstance().getArmor(References.InternalNames.Armor.MEDIEVALSHOES), new HashMap<MLAAddon, Integer>(), tMaterial.getBaseDurability(References.InternalNames.Armor.MEDIEVALSHOES), tMaterial.getUniqueID());
                AnvilRecipe tShoeRecipe = new AnvilRecipe().setCraftingSlotContent(6, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(8, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(10, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(11, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(13, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(14, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(15, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(16, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(18, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
                        .setCraftingSlotContent(19, (new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.CHAIN, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.85F, (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.35F) * 0.95F)))
        ...
        public static void initializeMedievalHelmetUpgradeAnvilRecipes() {
            for (IArmorMaterial tMaterial : MaterialRegistry.getInstance().getArmorMaterials().values()) {
                if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tMaterial, References.InternalNames.Upgrades.Helmet.TOP)) {
                    ...
                    pUpgradeCompound.setString(References.NBTTagCompoundData.CoreMaterial, tUpgrade.getUniqueMaterialID());
                    ...
                    AnvilRecipe tRecipe = new AnvilRecipe()
                            .setCraftingSlotContent(6, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(7, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(8, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(10, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(14, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                ...
                if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tMaterial, References.InternalNames.Upgrades.Helmet.LEFT)) {
                    ...
                    AnvilRecipe tRecipe = new AnvilRecipe()
                            .setCraftingSlotContent(13, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(18, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(23, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setResult(tUpgradeStack).setHammerUsage((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 300).setTongUsage((int) (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() - 1000) / 300).setProgress((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 100);
                ...
                if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tMaterial, References.InternalNames.Upgrades.Helmet.RIGHT)) {
                    ...
                    AnvilRecipe tRecipe = new AnvilRecipe()
                            .setCraftingSlotContent(11, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(16, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(21, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setResult(tUpgradeStack).setHammerUsage((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 300).setTongUsage((int) (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() - 1000) / 300).setProgress((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 100);
        ...
        public static void initializeMedievalChestPlateUpgradeAnvilRecipes() {
            for (IArmorMaterial tMaterial : MaterialRegistry.getInstance().getArmorMaterials().values()) {
                if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tMaterial, References.InternalNames.Upgrades.Chestplate.SHOULDERLEFT)) {
                    ...
                    AnvilRecipe tRecipe = new AnvilRecipe()
                            .setCraftingSlotContent(2, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(3, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(4, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(9, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setResult(tUpgradeStack).setHammerUsage((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 300).setTongUsage((int) (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() - 1000) / 300).setProgress((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 100);
                ...
                if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tMaterial, References.InternalNames.Upgrades.Chestplate.SHOULDERRIGHT)) {
                    ...
                    AnvilRecipe tRecipe = new AnvilRecipe()
                            .setCraftingSlotContent(0, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(1, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(2, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(5, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setResult(tUpgradeStack).setHammerUsage((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 300).setTongUsage((int) (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() - 1000) / 300).setProgress((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 100);
                ...
                if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tMaterial, References.InternalNames.Upgrades.Chestplate.BACKRIGHT)) {
                    ...
                    AnvilRecipe tRecipe = new AnvilRecipe()
                            ...
                            .setCraftingSlotContent(10, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(11, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(15, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(16, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(21, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setResult(tUpgradeStack).setHammerUsage((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 300).setTongUsage((int) (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() - 1000) / 300).setProgress((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 100);
                ...
                if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tMaterial, References.InternalNames.Upgrades.Chestplate.BACKLEFT)) {
                    ...
                    AnvilRecipe tRecipe = new AnvilRecipe()
                            ...
                            .setCraftingSlotContent(14, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(13, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(19, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(18, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(23, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setResult(tUpgradeStack).setHammerUsage((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 300).setTongUsage((int) (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() - 1000) / 300).setProgress((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 100);
                ...
                if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tMaterial, References.InternalNames.Upgrades.Chestplate.FRONTRIGHT)) {
                    ...
                    AnvilRecipe tRecipe = new AnvilRecipe()
                            ...
                            .setCraftingSlotContent(15, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(16, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(20, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setResult(tUpgradeStack).setHammerUsage((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 300).setTongUsage((int) (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() - 1000) / 300).setProgress((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 100);
                ...
                if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tMaterial, References.InternalNames.Upgrades.Chestplate.FRONTLEFT)) {
                    ...
                    AnvilRecipe tRecipe = new AnvilRecipe()
                            ...
                            .setCraftingSlotContent(18, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(19, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(24, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setResult(tUpgradeStack).setHammerUsage((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 300).setTongUsage((int) (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() - 1000) / 300).setProgress((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 100);
            ...
            for (IArmorMaterial tMaterial : MaterialRegistry.getInstance().getArmorMaterials().values()) {
                ...
                if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tMaterial, References.InternalNames.Upgrades.Leggings.FRONTRIGHT)) {
                    ...
                    AnvilRecipe tRecipe = new AnvilRecipe()
                            ...
                            .setCraftingSlotContent(7, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(11, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(12, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(16, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setCraftingSlotContent(17, new HeatedAnvilRecipeComponent(tMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.NUGGET, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() * 0.5F * 0.95F))
                            .setResult(tUpgradeStack).setHammerUsage((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 300).setTongUsage((int) (MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() - 1000) / 300).setProgress((int) MaterialRegistry.getInstance().getMaterial(tMaterial.getUniqueID()).getMeltingPoint() / 100);
            ...
            for (IArmorMaterial tArmorMaterial : MaterialRegistry.getInstance().getArmorMaterials().values()) {
                ...
                for (IArmorMaterial tUpgradeMaterial : MaterialRegistry.getInstance().getArmorMaterials().values()) {
                    if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tUpgradeMaterial, References.InternalNames.Upgrades.Helmet.TOP)) {
                        ItemStack tUpgradeStack = new ItemStack(ModItems.armorComponent, 1);
                        NBTTagCompound pUpgradeCompound = new NBTTagCompound();
                        pUpgradeCompound.setString(References.NBTTagCompoundData.CoreMaterial, tUpgradeMaterial.getUniqueID());
                        ...
                        AnvilRecipe tRecipe = new ArmorUpgradeAnvilRecipe(References.InternalNames.Armor.MEDIEVALHELMET, tArmorMaterial.getUniqueID())
                                .setCraftingSlotContent(6, new HeatedAnvilRecipeComponent(tArmorMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F))
                                .setCraftingSlotContent(8, new HeatedAnvilRecipeComponent(tArmorMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F))
                    ...
                    if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tUpgradeMaterial, References.InternalNames.Upgrades.Helmet.LEFT)) {
                        ...
                        AnvilRecipe tRecipe = new ArmorUpgradeAnvilRecipe(References.InternalNames.Armor.MEDIEVALHELMET, tArmorMaterial.getUniqueID())
                                .setCraftingSlotContent(6, new HeatedAnvilRecipeComponent(tArmorMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F))
                                .setCraftingSlotContent(16, new HeatedAnvilRecipeComponent(tArmorMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F))
                    ...
                    if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tUpgradeMaterial, References.InternalNames.Upgrades.Helmet.RIGHT)) {
                        ...
                        AnvilRecipe tRecipe = new ArmorUpgradeAnvilRecipe(References.InternalNames.Armor.MEDIEVALHELMET, tArmorMaterial.getUniqueID())
                                .setCraftingSlotContent(8, new HeatedAnvilRecipeComponent(tArmorMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F))
                                .setCraftingSlotContent(18, new HeatedAnvilRecipeComponent(tArmorMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F))
                ...
                for (IArmorMaterial tUpgradeMaterial : MaterialRegistry.getInstance().getArmorMaterials().values()) {
                    if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tUpgradeMaterial, References.InternalNames.Upgrades.Chestplate.SHOULDERLEFT)) {
                        ...
                        AnvilRecipe tRecipe = new ArmorUpgradeAnvilRecipe(References.InternalNames.Armor.MEDIEVALCHESTPLATE, tArmorMaterial.getUniqueID())
                                .setCraftingSlotContent(7, new HeatedAnvilRecipeComponent(tArmorMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F))
                                .setCraftingSlotContent(11, new HeatedAnvilRecipeComponent(tArmorMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F))
                    ...
                    if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tUpgradeMaterial, References.InternalNames.Upgrades.Chestplate.SHOULDERRIGHT)) {
                        ...
                        AnvilRecipe tRecipe = new ArmorUpgradeAnvilRecipe(References.InternalNames.Armor.MEDIEVALCHESTPLATE, tArmorMaterial.getUniqueID())
                                .setCraftingSlotContent(7, new HeatedAnvilRecipeComponent(tArmorMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F))
                                .setCraftingSlotContent(13, new HeatedAnvilRecipeComponent(tArmorMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F))
                    ...
                    if (MedievalAddonRegistry.getInstance().getPartStateForMaterial(tUpgradeMaterial, References.InternalNames.Upgrades.Chestplate.BACKRIGHT)) {
                        ...
                        AnvilRecipe tRecipe = new ArmorUpgradeAnvilRecipe(References.InternalNames.Armor.MEDIEVALCHESTPLATE, tArmorMaterial.getUniqueID())
                                .setCraftingSlotContent(13, new HeatedAnvilRecipeComponent(tArmorMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F))
                                .setCraftingSlotContent(17, new HeatedAnvilRecipeComponent(tArmorMaterial.getUniqueID(), References.InternalNames.HeatedObjectTypeNames.RING, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.85F, MaterialRegistry.getInstance().getMaterial(References.InternalNames.Materials.Vanilla.IRON).getMeltingPoint() * 0.5F * 0.95F))
    ...
    public static class GlobalInitialization {
        public static void registerAnvilMaterials() {
            AnvilMaterialRegistry.getInstance().registerNewAnvilMaterial(new StandardAnvilMaterial(References.InternalNames.Materials.Anvil.STONE, 250, TranslationKeys.Materials.Anvil.Stone));
            AnvilMaterialRegistry.getInstance().registerNewAnvilMaterial(new StandardAnvilMaterial(References.InternalNames.Materials.Anvil.IRON, 1500, TranslationKeys.Materials.Anvil.Iron));
            AnvilMaterialRegistry.getInstance().registerNewAnvilMaterial(new StandardAnvilMaterial(References.InternalNames.Materials.Anvil.OBSIDIAN, 2200, TranslationKeys.Materials.Anvil.Obsidian));
        }
    }
    ...
    public static class SystemInit {
        ...
        public static void registerItems() {
            ...
            ModItems.metalRing = new ItemHeatableMetalRing();
            ModItems.metalChain = new ItemHeatableMetalChain();
            ModItems.metalNugget = new ItemHeatableNugget();
            ModItems.metalPlate = new ItemHeatablePlate();
        ...
        public static void tryRemoveRecipeFromGame(@Nonnull IRecipe recipe, @Nonnull Iterator iterator) {
        ...
        public static void initializeOreDict() {
            ...
            ((ItemHeatableResource) ModItems.metalChain).buildSubItemList(ModItems.metalChain, null, chains);
            ((ItemHeatableResource) ModItems.metalNugget).buildSubItemList(ModItems.metalNugget, null, chains);
            ((ItemHeatableResource) ModItems.metalPlate).buildSubItemList(ModItems.metalPlate, null, chains);
            ((ItemHeatableResource) ModItems.metalRing).buildSubItemList(ModItems.metalRing, null, chains);

            for (ItemStack chain : chains) {
                String material = chain.getTagCompound().getString(References.NBTTagCompoundData.CoreMaterial);
            ...
            for (ItemStack ring : rings) {
                String material = ring.getTagCompound().getString(References.NBTTagCompoundData.CoreMaterial);
            ...
            for (ItemStack plate : plates) {
                String material = plate.getTagCompound().getString(References.NBTTagCompoundData.CoreMaterial);
            ...
            for (ItemStack nugget : nuggets) {
                String material = nugget.getTagCompound().getString(References.NBTTagCompoundData.CoreMaterial);
